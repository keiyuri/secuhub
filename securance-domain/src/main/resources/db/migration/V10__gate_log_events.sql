...
CREATE TABLE tb_data_rcv_log (
    ...
    PRIMARY KEY (log_id),
    KEY idx_data_rcv_log_rcv_date (rcv_date),
    KEY idx_data_rcv_log_dtl_ip_lane (dtl_ip, dtl_lane_no)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci
  COMMENT='게이트 로그 이벤트(0x61, 36바이트 구조) — 레거시 TB_DATA_RCV_LOG 대응';
