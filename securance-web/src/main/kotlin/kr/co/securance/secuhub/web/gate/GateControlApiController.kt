...
class GateControlApiController(
    private val gateControlService: ServerGateControlService,
    private val faultResolutionService: GateFaultResolutionService,
) {
    private val logger = LoggerFactory.getLogger(GateControlApiController::class.java)
